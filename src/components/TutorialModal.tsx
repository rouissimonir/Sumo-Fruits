...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    icon: '🧂',
    color: '#9B59B6',
    bodyEn: 'Watch out for sliding Ice Cubes, sticky Wasabi puddles, and wild Chili boosters. Tap the Salt skill, then tap the Dohyō to cast Kiyome-no-Shio and purify nearby hazards.',
    bodyJa: '滑る氷、粘るワサビ、勢いよく飛び出す唐辛子に注意しましょう。「清めの塩」を押してから土俵をタップすると、近くの障害物を浄化できます。',
    keyPointsEn: [
