          ...
          <div className="hidden sm:flex items-center gap-1.5">
            ...
            {onSelectGameMode && (
              <button
                ...
                onClick={() => {
                  const modes: GameModeType[] = ['CLASSIC', 'VERSUS', 'CAREER', 'CHALLENGE'];
                ...
                title={`Game Mode: ${stats.gameMode}. Click to switch between Classic Dohyō, 2P Versus, Career Banzuke, and Challenges.`}
              ...
              >
                ...
                <span className="text-[10px] uppercase font-bold">
                  {stats.gameMode === 'VERSUS' ? '2P Versus' : stats.gameMode === 'CAREER' ? `Banzuke ${stats.careerStageIndex + 1}/5` : stats.gameMode === 'CHALLENGE' ? 'Challenge' : 'Classic'}
                </span>
              </button>
            )}
            ...
            {stats.arenaCondition && stats.arenaCondition.type !== 'NONE' && (
              <div className="flex items-center gap-1.5 bg-[#1C1814]/90 backdrop-blur-md border border-[#E67E22] px-2.5 py-1 rounded-xl shadow-lg">
                ...
                <span className="text-[10px] font-black text-[#FFD700] tracking-wider">
                  {CONDITION_METADATA[stats.arenaCondition.type].japanese}
                </span>
              </div>
            )}
