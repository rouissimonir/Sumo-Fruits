        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#3D2E24] bg-[#241E19]">
            <div className="flex items-center gap-3">
              <motion.div
                ...
                className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FFD700]/20 to-[#E67E22]/20 border border-[#FFD700]/40 flex items-center justify-center text-xl shadow-inner"
              >
                🥋
              </motion.div>
              <div>
          ...
          <div className="px-5 py-3 border-t border-[#3D2E24] bg-[#241E19] flex items-center justify-between text-xs text-[#A89886]">
            ...
            <motion.button
              ...
              onClick={onClose}
              className="px-4 py-1.5 rounded-lg bg-[#3E3125] hover:bg-[#5A4535] text-white font-bold transition-colors cursor-pointer"
            >
              Close
            </motion.button>
          </div>
