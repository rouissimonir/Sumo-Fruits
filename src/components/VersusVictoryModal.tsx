...
export const VersusVictoryModal: React.FC<VersusVictoryModalProps> = ({
  ...
  const isOpen = !!(versus?.isMatchOver && versus?.matchWinner);
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md text-[#EDE2D4]"
        >
          <motion.div
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="relative space-y-2">
              <motion.div
                ...
                transition={{ type: 'spring', stiffness: 450, damping: 16, delay: 0.06 }}
                className="w-20 h-20 mx-auto rounded-2xl bg-[#2A211B] border-2 border-[#FFD700] flex items-center justify-center text-4xl shadow-[0_0_30px_rgba(255,215,0,0.4)]"
              >
                🏆
              </motion.div>
            ...
            <motion.div
              ...
              className="inline-block px-4 py-1 rounded-full bg-[#3D2C1E] border border-[#FFD700]/60 text-xs font-black tracking-widest uppercase text-[#FFD700]"
            >
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <motion.button
              ...
              onClick={onRematch}
              className="py-3 px-4 rounded-xl bg-gradient-to-r from-[#D35400] to-[#E67E22] hover:from-[#E67E22] hover:to-[#F39C12] text-white font-black text-sm transition-colors shadow-lg hover:shadow-[#E67E22]/30 cursor-pointer flex items-center justify-center gap-2"
            >
              <RotateCcw size={16} />
            ...
            <motion.button
              ...
              className="py-3 px-4 rounded-xl bg-[#2C231C] hover:bg-[#3D3027] border border-[#5A4535] text-white font-bold text-sm transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
              <Play size={16} />
